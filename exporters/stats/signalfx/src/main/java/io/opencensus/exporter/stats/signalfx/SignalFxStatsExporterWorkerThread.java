...
final class SignalFxStatsExporterWorkerThread extends Thread {
  ...
  SignalFxStatsExporterWorkerThread(URL url, String token, Duration interval, ViewManager views) {
    this.intervalMs =
    ...
    this.sender =
        new AggregateMetricSender(
            ...
            Collections.singleton(ERROR_HANDLER));
