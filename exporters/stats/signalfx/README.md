...
compile 'io.opencensus:opencensus-impl:0.10.0'
runtime 'io.opencensus:opencensus-exporter-stats-signalfx:0.10.0'
```
...
SignalFxStatsExporter.create("your_signalfx_token", Duration.create(5, 0));
```
